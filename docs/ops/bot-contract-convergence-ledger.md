...
| Phase 6 Current-SHA Bot Ready      | Index Phase 6; acceptance Tasks 3-5 | `d4c449d53cb1e319c74221c87be53013d86855ec` | local/CI    | Knowledge context packet   | 18 focused; 2 context      | wrapper seam             | Acceptance plan | Needs Verification | full gate + SHA manifest absent | keep flags dark          |
