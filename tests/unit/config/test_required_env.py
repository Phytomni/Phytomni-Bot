...
def test_outbound_required_fields_are_the_finite_logical_pool_contract() -> (
    ...
    threshold."""
    expected_text = """
        OUTBOUND_INTEROP_CONCURRENCY OUTBOUND_POOL_WAIT_WARN_SECONDS
        OUTBOUND_RELAY_CONTROL_CONCURRENCY OUTBOUND_OBS_CONCURRENCY
        OUTBOUND_BI_CONCURRENCY OUTBOUND_SPA_FAQ_CONCURRENCY
        OUTBOUND_IAM_CONCURRENCY OUTBOUND_ANALYSIS_STATUS_CONCURRENCY
        OUTBOUND_ANALYSIS_CONTROL_CONCURRENCY OUTBOUND_NL2SQL_CONCURRENCY
        OUTBOUND_RERANK_CONCURRENCY OUTBOUND_RETRIEVAL_CONCURRENCY
