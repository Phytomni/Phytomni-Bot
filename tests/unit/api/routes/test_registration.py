...
def test_admin_and_run_registration_preserve_public_contract() -> None:
    ...
    assert manifest == [
        ...
        ("/v1/executions/{execution_id}/events", ("GET",)),
        ("/v1/runs/{run_id}/logs", ("GET",)),
        ("/v1/runs/{run_id}/events", ("GET",)),
        ("/v1/runs/{run_id}/event-projection", ("GET",)),
        ("/v1/runs/{run_id}/events/stream", ("GET",)),
        ("/v1/runs/{run_id}/events/{event_id}", ("GET",)),
        ("/v1/executions/{execution_id}/event-projection", ("GET",)),
        ("/v1/executions/{execution_id}/events/stream", ("GET",)),
        ("/v1/executions/{execution_id}/events/{event_id}", ("GET",)),
        ("/v1/runs/{run_id}", ("GET",)),
