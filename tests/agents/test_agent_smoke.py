...
from mcp_server_phytomni.knowledge_agents import KnowledgeAgent
from mcp_server_phytomni.review_agents import DeepResearchAgent
...
async def test_gene_network_agent_arun_invokes_graph_with_initial_state():
    ...
    assert fake_graph.state is not None
    assert fake_graph.state["species"] == "osa"
...
async def test_digital_design_agent_arun_invokes_graph_with_initial_state():
    ...
    assert fake_graph.state is not None
    assert fake_graph.state["species"] == "ath"
