...
"""Private Review marker seams mixed into the durable context store."""
...
__all__ = ["ConversationContextReviewMixin"]


class ConversationContextReviewMixin:
    """Keep private Review marker validation off the primary store module."""
    ...
    def _claim_is_expired(
        cls, claimed_at: str, *, clock: datetime, stale_after: timedelta
    ) -> bool:
        try:
            claimed_clock = cls._claim_datetime(claimed_at)
