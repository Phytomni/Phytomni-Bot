...
Exports BriefGeneAgent state and graph nodes, the public
brief_gene_function wrapper used by MCP handlers, and backward-compat
re-exports of pipeline helpers for existing importers.
"""
