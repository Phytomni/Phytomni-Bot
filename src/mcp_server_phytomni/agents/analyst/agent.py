...
# Late import to break the AnalystAgent <-> submission cycle: the new
# submission module needs ``AnalystAgent`` to construct cached instances
# (see _build_submit_agent), and agent.py re-exports submission symbols
# for backward compatibility. Placing this import after the class
# definition lets submission.py's top-level ``from .agent import
# AnalystAgent`` succeed against the partially-loaded module. Step 10.5
# will dissolve the cycle by relocating AnalystAgent to its own module.
from .submission import (  # noqa: E402  pylint: disable=wrong-import-position
